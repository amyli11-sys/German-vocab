...
function renderCurrentCard() {
  ...
  document.getElementById("backSentenceDE").textContent = w.sentenceDE;
...
async function init() {
  ...
  document.getElementById("flashcard").addEventListener("click", () => { if (!flipped) flipCard(); });
  ...
  document.getElementById("resetBtn").addEventListener("click", () => {
    if (confirm("This will erase all review progress on this device. Continue?")) {
