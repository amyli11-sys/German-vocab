...
2. Upload every file in this folder to the repo root — all flat, no
   subfolders: `index.html`, `styles.css`, `app.js`, `data.json`,
   `manifest.json`, `sw.js`, `icon-180.png`, `icon-192.png`, `icon-512.png`.
   - Click **Add file → Upload files**, drag everything in, commit.
...
- `manifest.json` + `sw.js` + `icon-180.png`, `icon-192.png`, `icon-512.png` — PWA installability & offline support
